...
class Model(nn.Module):
    def __init__(self, input_channels, embedding_channels, time_range, window, output_channels):
        ...
        self.deconv2 = nn.Conv1d(intermediate_channels, output_channels, time_range, stride=1, padding=int((time_range - 1) / 2), dilation=1, groups=1, bias=True, padding_mode='zeros')
    ...
    def forward(self, x):
        ...
        y = y.reshape(y.shape[0], self.output_channels*self.time_range)
